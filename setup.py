...
PACKAGENAME = metadata.get('package_name', 'model-star-spec')
DESCRIPTION = metadata.get('description', 'Model star spectrum')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: model-star-spec requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
